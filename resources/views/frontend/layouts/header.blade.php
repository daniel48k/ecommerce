                    ...
                    <div class="search-bar-top">
                        <div class="search-bar">
                            <select>
                                ...
                                @foreach(availableCategoriesWithProducts() as $cat)
                                    <option>{{$cat->name}}</option>
                                @endforeach
                            </select>
                            <form method="GET" action="{{route('shop.filter',request()->all())}}">
                            ...
                            @if(getAllProductFromCart())
                                <div class="sinlge-bar shopping">
                                    <a href="{{route('cart')}}" class="single-icon"><i class="ti-bag"></i> <span
                                            class="total-count">{{count(getAllProductFromCart())}}</span></a>
                                    <!-- Shopping Item -->
                                    @auth
                                        <div class="shopping-item">
                                            ...
                                            <div class="bottom">
                                                <div class="total">
                                                    <span>Total</span>
                                                    <span
                                                        class="total-amount">${{number_format(totalCartPrice(),2)}}</span>
                                                </div>
                                        ...
                                        <div class="nav-inner">
                                            <ul class="nav main-menu menu navbar-nav">
                                                ...
                                                <li class="{{Request::path()=='about-us' ? 'active' : ''}}"><a
                                                        href="#">About Us</a></li>
                                                <li class="@if(Request::path()=='product-grids'||Request::path()=='filter')  active  @endif">
                                                    <a href="{{route('shop.filter')}}">Products</a><span
                                                        class="new">New</span></li>
                                                {{--                                            {{Helper::getHeaderCategory()}}--}}
                                                {{--                                            <li class="{{Request::path()=='blog' ? 'active' : ''}}"><a--}}
                                                {{--                                                    href="{{route('blog')}}">Blog</a></li>--}}

                                                <li class="{{Request::path()=='contact' ? 'active' : ''}}"><a href="#">Contact
                                                        Us</a></li>
                                            </ul>
                                        </div>
                                    </div>
